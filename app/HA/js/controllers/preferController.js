define(['views/preferView'], function (View) {
  var nextPage = 'choice.html';

  var bindings = [{
    element: '.prefer-submit-button',
    event: 'click',
  ...
  function scrollToTopic(index) {
    ...
    $$('#preferContent').scrollTop(offset - gutter, 200);
  }
  ...
  function autoNext() {
    ...
    if (index == topic_length) {
      var nextBtn = $$('.prefer-submit-button');
  ...
  function formatAnswers() {
    ...
    var resultData = haApp.formToJSON('#preferForm');
    var resultArray = [];
    var answers;
